...
const MOCK_LOGS: ActivityLog[] = [
  ...
  { id: "8", timestamp: "2024-03-17T16:00:00Z", user: "David Kim", userEmail: "david@medhealth.com", action: "Updated", actionType: "update", module: "Roles", entity: "TAP Role", ipAddress: "192.168.2.1", status: "success", details: "Updated permissions for TAP role - added export access" },
